...
SCRIPTED_TEXTS_DEFAULTS = {
    ...
    # 3) Ответ после выбора «2» / «Дебет» — направление в ручном режиме.
    # По дебету CRM-флоу не запущен: цены и работа ведутся менеджером
    # вручную. SIMBA обновляет этот текст через `/edit reply_debet` в
    # группе «Асик Админка» (id -1004377257144).
    "reply_debet": {
        ...
        "text": (
            ...
            "Менеджер свяжется с вами в этом чате в ближайшее время "
            "и расскажет об актуальных банках и ценах.\n\n"
            "Если вопрос срочный — напишите: «Ассистент позови оператора»."
        ),
        "entities": [],
    },
    ...
    # ═══════════════════════════════════════════════════════════════════
    # SIMBA 2026-08: PAM (post-perevyaz agreement) — сообщения-соглашения
    # с условиями работы по банку. Показываются после успешного перевяза
    # ЛК (авто) или командой /pam<bank> от менеджера/owner. У каждого
    # сообщения инлайн-кнопка «Согласен» — клик логируется в
    # LEGAL_CONSENT_LOG_CHAT_ID (полный текст условий + ссылка на юзера +
    # его TG ID). SIMBA правит тексты через /edit pam_<bank> в Асик Админке.
    # Placeholder'ы {client_tag} {bank} {fio} — доступны при подстановке.
    # ═══════════════════════════════════════════════════════════════════
    "pam_alfa": {
        "title": "📋 PAM · Альфа",
        "text": (
            "{client_tag}Условия работы по АЛЬФА:\n\n"
            "— [SIMBA обновит текст через /edit pam_alfa в Асик Админке]\n\n"
            "Нажми «Согласен» чтобы подтвердить принятие условий."
        ),
        "entities": [],
    },
    "pam_ozon": {
        "title": "📋 PAM · Озон",
        "text": (
            "{client_tag}Условия работы по ОЗОН:\n\n"
            "— [SIMBA обновит текст через /edit pam_ozon]\n\n"
            "Нажми «Согласен» чтобы подтвердить."
        ),
        "entities": [],
    },
    "pam_raif": {
        "title": "📋 PAM · Райф",
        "text": (
            "{client_tag}Условия работы по РАЙФ:\n\n"
            "— [SIMBA обновит текст через /edit pam_raif]\n\n"
            "Нажми «Согласен» чтобы подтвердить."
        ),
        "entities": [],
    },
    "pam_sber": {
        "title": "📋 PAM · Сбер",
        "text": (
            "{client_tag}Условия работы по СБЕР:\n\n"
            "— [SIMBA обновит текст через /edit pam_sber]\n\n"
            "Нажми «Согласен» чтобы подтвердить."
        ),
        "entities": [],
    },
    "pam_vtb": {
        "title": "📋 PAM · ВТБ",
        "text": (
            "{client_tag}Условия работы по ВТБ:\n\n"
            "— [SIMBA обновит текст через /edit pam_vtb]\n\n"
            "Нажми «Согласен» чтобы подтвердить."
        ),
        "entities": [],
    },
    "pam_bbr": {
        "title": "📋 PAM · ББР",
        "text": (
            "{client_tag}Условия работы по ББР:\n\n"
            "— [SIMBA обновит текст через /edit pam_bbr]\n\n"
            "Нажми «Согласен» чтобы подтвердить."
        ),
        "entities": [],
    },
    "pam_gaz": {
        "title": "📋 PAM · Газпром",
        "text": (
            "{client_tag}Условия работы по ГАЗПРОМ:\n\n"
            "— [SIMBA обновит текст через /edit pam_gaz]\n\n"
            "Нажми «Согласен» чтобы подтвердить."
        ),
        "entities": [],
    },
