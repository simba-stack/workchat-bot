...
SCRIPTED_TEXTS_DEFAULTS = {
    ...
    "ask_payment_method_after_perevyaz": {
        "title": "💰 Спросить метод оплаты после перевязки",
        "text": (
            "{client_tag}Перевязка успешно завершена.\n\n"
            "Подскажите — как хотите получить выплату по этому ЛК?\n\n"
            "💸 USDT TRC20 — пришлите ваш TRC20-адрес, "
            "переведём сразу после отработки счёта операционистами\n"
            "🤝 Гарант в Continental (сделка с @PRIDE_CL)\n"
    ...
    "reply_payment_guarantor_after": {
        ...
        "text": (
            ...
            "по факту завершения работы со счётом. Сделка с @PRIDE_CL."
        ),
        "entities": [],
    },
