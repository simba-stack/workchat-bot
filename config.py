...
SCRIPTED_TEXTS_DEFAULTS = {
    ...
    "payment_guarantor_deposited": {
        "title": "💰 Средства в гарант внесены (v2)",
        "text": (
            "💰 <b>Сделка №{deal_number} пополнена!</b>\n\n"
            "Теперь перейдите в @PrideCONTROLE_bot и заполните данные ЛК "
            "(инструкция откроется автоматически)."
        ),
        "entities": [],
    },
    "payment_usdt_prompt": {
        ...
        "text": (
            ...
            "Сейчас переходим к заполнению данных ЛК — инструкция откроется ниже."
        ),
        "entities": [],
    },
}
