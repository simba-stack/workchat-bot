...
SCRIPTED_TEXTS_DEFAULTS = {
    ...
    "ask_payment_method_after_perevyaz": {
        ...
        "text": (
            ...
            "🤝 <b>Гарант</b> — через Continental. Пришлите номер сделки "
            "@PRIDE_BUHGALTERIA, мы пополним и отпустим по регламенту.\n\n"
            "💸 <b>USDT TRC20</b> — оплата напрямую на кошелёк после отработки счёта. "
            "Адрес USDT попросим отдельно, когда счёт будет готов."
        ),
        "entities": [],
    },
