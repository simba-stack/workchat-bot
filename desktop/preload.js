...
function injectUpdateBanner() {
  ...
  banner.innerHTML = `
    ...
    <button class="pub-btn" id="pride-update-btn" style="display:none;">Установить сейчас</button>
...
function renderUpdateState(state) {
  ...
  if (state.status === "ready") {
    banner.classList.add("visible");
    text.textContent = `✅ Обновление v${state.version || ""} готово — установится автоматически при перезапуске`;
    progressBox.style.display = "none";
