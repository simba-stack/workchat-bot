...
def _classifier_prompt(text: str) -> str:
    ...
    return (
        ...
        f"Доступные файлы:\n{files}\n\n"
        "Правила:\n"
        "1. Если сообщение НЕ факт о компании (приветствие, эмоция, мета-вопрос, "
        "болтовня) — верни JSON {\"skip\": true, \"reason\": \"короткое объяснение\"}.\n"
        "2. Иначе верни JSON: {\"file\": \"имя.md\", \"content\": \"markdown-блок\", "
        "\"commit_message\": \"ai-knowledge: краткое описание\"}.\n"
        "3. content начинается с h2/h3 заголовка (## или ###), затем 1-3 короткие "
        "строки с фактом. Можно [[wiki-links]] на другие knowledge-файлы.\n"
        "4. file — одно из перечисленных или новое в формате 'lowercase-name.md' "
        "(латиница, без пробелов).\n"
        "5. ТОЛЬКО валидный JSON, никакого пояснительного текста до или после!\n\n"
